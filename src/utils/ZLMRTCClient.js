var ZLMRTCClient = (function (exports) {
  ...
  const BUILD_DATE = 'Sat May 10 2025 17:31:48 GMT+0800 (中国标准时间)'
  ...
  var xhr = function xhrAdapter(config) {
    return new Promise(function dispatchXhrRequest(resolve, reject) {
      ...
      request.onerror = function handleError() {
        ...
        reject(
          new AxiosError_1('Network Error', AxiosError_1.ERR_NETWORK, config, request, request)
        )
  ...
  class RTCEndpoint extends Event$1 {
    ...
    switchVideo(useCamera, deviceId) {
      ...
      return MediaStreamFactory.createMediaStream(
    ...
    switcAudio(useMic, deviceId) {
      ...
      return MediaStreamFactory.createMediaStream(
        new StreamConstraints(audioConstraints, false)
      ).then((stream) => {
